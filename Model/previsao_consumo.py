...
def executar_previsao_consumo():
    ...
    try:
        results_df.to_sql('previsao_consumo_resultados', engine, schema='public', if_exists='replace', index=False)
        feature_importance_df.to_sql('previsao_consumo_importancia_features', engine, schema='public', if_exists='replace', index=False)
